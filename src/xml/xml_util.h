...
const char CONTRACTHOUR[]  = "contracthour";
...
const char DI[]            = "di";
const char DO[]            = "do";
const char DYNVISC[]       = "dynviscosity";
const char DWORD[]         = "dword";
const char ETHERNET[]      = "ethernet";
const char EVENTS[]        = "events";
const char EVENTSTORAGE[]  = "eventstorage";
const char EXTERNAL[]      = "external";
const char FACTORS[]       = "factors";
const char FAULT[]         = "fault";
const char FAULT_1[]       = "fault_1";
const char FAULT_2[]       = "fault_2";
const char FAULT_3[]       = "fault_3";
const char FAULT_4[]       = "fault_4";
...
const char INPUT_3[]       = "input_3";
const char INPUT_4[]       = "input_4";
...
const char KF[]            = "kf";
const char KINVISC[]       = "kinviscosity";
...
const char MASSWATER[]     = "masswater";
const char MAX[]           = "max";
...
const char STABILIZE[]     = "stabilize";
...
const char VOLUME15[]      = "volume15";
const char VOLUME20[]      = "volume20";
const char VOLWATER[]      = "volwater";
