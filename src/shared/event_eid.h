...
CREATE_EID(EID_DO_NEW_SIMULATE        , EMT_SUCCESS, EVENT_OBJ_DO      ,  10)
CREATE_EID(EID_DO_CH_FAULT            , EMT_ERROR  , EVENT_OBJ_DO      ,  11)
CREATE_EID(EID_DO_CH_OK               , EMT_SUCCESS, EVENT_OBJ_DO      ,  12)
CREATE_EID(EID_DO_KEYPAD_ON           , EMT_WARNING, EVENT_OBJ_DO      ,  13)
CREATE_EID(EID_DO_KEYPAD_OFF          , EMT_WARNING, EVENT_OBJ_DO      ,  14)
CREATE_EID(EID_DO_MODULE              , EMT_ERROR  , EVENT_OBJ_DO      ,  15)
CREATE_EID(EID_DO_NEW_SETUP           , EMT_SUCCESS, EVENT_OBJ_DO      ,  16)
