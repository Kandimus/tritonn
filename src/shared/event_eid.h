...
CREATE_EID(EID_PROVE_STATE_VALVETOUP  , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  44)
CREATE_EID(EID_PROVE_STATE_WAITTOUP   , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  45)
CREATE_EID(EID_PROVE_STATE_VALVETODOWN, EMT_SUCCESS, EVENT_OBJ_PROVE   ,  46)
CREATE_EID(EID_PROVE_STATE_WAITD1     , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  47)
CREATE_EID(EID_PROVE_STATE_WAITD2     , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  48)
CREATE_EID(EID_PROVE_STATE_CALCULATE  , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  49)
CREATE_EID(EID_PROVE_STATE_RETURNBALL , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  50)
CREATE_EID(EID_PROVE_STATE_WAITED1_RVS, EMT_SUCCESS, EVENT_OBJ_PROVE   ,  51)
CREATE_EID(EID_PROVE_STATE_WAITED2_RVS, EMT_SUCCESS, EVENT_OBJ_PROVE   ,  52)
CREATE_EID(EID_PROVE_STATE_WAYCOMPLTED, EMT_SUCCESS, EVENT_OBJ_PROVE   ,  53)
CREATE_EID(EID_PROVE_STATE_FINISH     , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  54)
CREATE_EID(EID_PROVE_STATE_ABORT      , EMT_WARNING, EVENT_OBJ_PROVE   ,  55)
CREATE_EID(EID_PROVE_STATE_ERRORFLOW  , EMT_ERROR  , EVENT_OBJ_PROVE   ,  56)
CREATE_EID(EID_PROVE_STATE_ERRORSTAB  , EMT_ERROR  , EVENT_OBJ_PROVE   ,  57)
CREATE_EID(EID_PROVE_STATE_ERRORTOUP  , EMT_ERROR  , EVENT_OBJ_PROVE   ,  58)
CREATE_EID(EID_PROVE_STATE_ERRORTDOWN , EMT_ERROR  , EVENT_OBJ_PROVE   ,  59)
CREATE_EID(EID_PROVE_STATE_ERRORD1    , EMT_ERROR  , EVENT_OBJ_PROVE   ,  60)
CREATE_EID(EID_PROVE_STATE_ERRORD2    , EMT_ERROR  , EVENT_OBJ_PROVE   ,  61)
CREATE_EID(EID_PROVE_STATE_ERRORDETS  , EMT_ERROR  , EVENT_OBJ_PROVE   ,  62)
CREATE_EID(EID_PROVE_STATE_ERRORRETURN, EMT_ERROR  , EVENT_OBJ_PROVE   ,  63)
CREATE_EID(EID_PROVE_STATE_ERRORRSTRID, EMT_ERROR  , EVENT_OBJ_PROVE   ,  64)
CREATE_EID(EID_PROVE_STATE_ERRORD1_RVS, EMT_ERROR  , EVENT_OBJ_PROVE   ,  65)
CREATE_EID(EID_PROVE_STATE_ERRORD2_RVS, EMT_ERROR  , EVENT_OBJ_PROVE   ,  66)
// Prove.Limits
