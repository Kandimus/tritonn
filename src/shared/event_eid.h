...
// Prove.Command
CREATE_EID(EID_PROVE_COMMANDSTART     , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  11)
CREATE_EID(EID_PROVE_COMMANDABORT     , EMT_WARNING, EVENT_OBJ_PROVE   ,  12)
CREATE_EID(EID_PROVE_COMMANDRESET     , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  13)
CREATE_EID(EID_PROVE_NOTSTARTED       , EMT_WARNING, EVENT_OBJ_PROVE   ,  14)
CREATE_EID(EID_PROVE_ALREADYSTARTED   , EMT_WARNING, EVENT_OBJ_PROVE   ,  15)
CREATE_EID(EID_PROVE_NOTERROR         , EMT_WARNING, EVENT_OBJ_PROVE   ,  16)
CREATE_EID(EID_PROVE_ISERROR          , EMT_WARNING, EVENT_OBJ_PROVE   ,  17)
// Prove.detectors
CREATE_EID(EID_PROVE_DETECTOR1        , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  21)
CREATE_EID(EID_PROVE_DETECTOR2        , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  22)
CREATE_EID(EID_PROVE_DETECTOR3        , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  23)
CREATE_EID(EID_PROVE_DETECTOR4        , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  24)
// Prove.State
CREATE_EID(EID_PROVE_STATE_IDLE       , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  31)
CREATE_EID(EID_PROVE_STATE_START      , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  32)
CREATE_EID(EID_PROVE_STATE_STAB       , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  33)
CREATE_EID(EID_PROVE_STATE_VALVETOUP  , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  34)
CREATE_EID(EID_PROVE_STATE_WAITTOUP   , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  35)
CREATE_EID(EID_PROVE_STATE_VALVETODOWN, EMT_SUCCESS, EVENT_OBJ_PROVE   ,  36)
CREATE_EID(EID_PROVE_STATE_WAITD1     , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  37)
CREATE_EID(EID_PROVE_STATE_WAITD2     , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  38)
CREATE_EID(EID_PROVE_STATE_CALCULATE  , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  39)
CREATE_EID(EID_PROVE_STATE_RETURNBALL , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  40)
CREATE_EID(EID_PROVE_STATE_FINISH     , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  41)
CREATE_EID(EID_PROVE_STATE_ABORT      , EMT_WARNING, EVENT_OBJ_PROVE   ,  42)
CREATE_EID(EID_PROVE_STATE_ERRORFLOW  , EMT_ERROR  , EVENT_OBJ_PROVE   ,  43)
CREATE_EID(EID_PROVE_STATE_ERRORSTAB  , EMT_ERROR  , EVENT_OBJ_PROVE   ,  44)
CREATE_EID(EID_PROVE_STATE_ERRORTOUP  , EMT_ERROR  , EVENT_OBJ_PROVE   ,  45)
CREATE_EID(EID_PROVE_STATE_ERRORTDOWN , EMT_ERROR  , EVENT_OBJ_PROVE   ,  46)
CREATE_EID(EID_PROVE_STATE_ERRORD1    , EMT_ERROR  , EVENT_OBJ_PROVE   ,  47)
CREATE_EID(EID_PROVE_STATE_ERRORD2    , EMT_ERROR  , EVENT_OBJ_PROVE   ,  48)
CREATE_EID(EID_PROVE_STATE_ERRORDETS  , EMT_ERROR  , EVENT_OBJ_PROVE   ,  49)
CREATE_EID(EID_PROVE_STATE_ERRORRETURN, EMT_ERROR  , EVENT_OBJ_PROVE   ,  50)
CREATE_EID(EID_PROVE_STATE_ERRORRSTRID, EMT_ERROR  , EVENT_OBJ_PROVE   ,  51)
// Prove.Limits
