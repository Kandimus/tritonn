...
CREATE_EID(EID_PROVE_STATE_FINISH     , EMT_SUCCESS, EVENT_OBJ_PROVE   ,  51)
CREATE_EID(EID_PROVE_STATE_ABORT      , EMT_WARNING, EVENT_OBJ_PROVE   ,  52)
CREATE_EID(EID_PROVE_STATE_ERRORFLOW  , EMT_ERROR  , EVENT_OBJ_PROVE   ,  53)
CREATE_EID(EID_PROVE_STATE_ERRORSTAB  , EMT_ERROR  , EVENT_OBJ_PROVE   ,  54)
CREATE_EID(EID_PROVE_STATE_ERRORTOUP  , EMT_ERROR  , EVENT_OBJ_PROVE   ,  55)
CREATE_EID(EID_PROVE_STATE_ERRORTDOWN , EMT_ERROR  , EVENT_OBJ_PROVE   ,  56)
CREATE_EID(EID_PROVE_STATE_ERRORD1    , EMT_ERROR  , EVENT_OBJ_PROVE   ,  57)
CREATE_EID(EID_PROVE_STATE_ERRORD2    , EMT_ERROR  , EVENT_OBJ_PROVE   ,  58)
CREATE_EID(EID_PROVE_STATE_ERRORDETS  , EMT_ERROR  , EVENT_OBJ_PROVE   ,  59)
CREATE_EID(EID_PROVE_STATE_ERRORRETURN, EMT_ERROR  , EVENT_OBJ_PROVE   ,  60)
CREATE_EID(EID_PROVE_STATE_ERRORRSTRID, EMT_ERROR  , EVENT_OBJ_PROVE   ,  61)
// Prove.Limits
