...
enum rTritonn_Error
{
	...
	DATACFGERR_RESERV4____________,         // 172
	DATACFGERR_RESERV5____________,         //
	...
	DATACFGERR_IO_CHANNEL,                  // 182
	DATACFGERR_INVALID_NAME,                //
	DATACFGERR_INVALID_MODULELINK,          // 184
	DATACFGERR_REALTIME_MODULELINK,         //
	DATACFGERR_NOTSYSTEXTFILE,              // 186
	DATACFGERR_INTERFACES_BADNAME,          //
	DATACFGERR_DI,                          // 188
	DATACFGERR_DO,                          //
	DATACFGERR_SAMPLER_TOTALS,              // 190
	DATACFGERR_SAMPLER_CAN,                 //
	DATACFGERR_SAMPLER_METHOD,              // 192
	DATACFGERR_SAMPLER_SETUP,               //
	DATACFGERR_SAMPLER_RESERVE,             // 194
	DATACFGERR_SAMPLER_RESERVE_NF,          //
	DATACFGERR_OBJECT_UNITS,                // 196
	DATACFGERR_PORVE_MISSINGMODULE,         //
	DATACFGERR_AVERAGE_NOINPUT,             // 198
	DATACFGERR_AVERAGE_TOOMANYINPUT,        //
	DATACFGERR_AVERAGE_TOOFEWINPUT,         // 200
	DATACFGERR_AVERAGE_DIFFUNITS,           //
	DATACFGERR_AVERAGE_DIFFFAULTS,          // 202
	DATACFGERR_AVERAGE_TOOMANYFAULTS,       //
	DATACFGERR_AVERAGE_SETUP,               // 204
	DATACFGERR_MASSWATER_SETUP,             //
	DATACFGERR_MASSWATER_NOVOLWATER,        // 206
	DATACFGERR_MASSWATER_NODENSITY,         //
	DATACFGERR_MASSWATER_NOTEMPERATURE,     // 208
	DATACFGERR_VOLWATER_SETUP,              //
	DATACFGERR_VOLWATER_NOMASSWATER,        // 210
	DATACFGERR_VOLWATER_NODENSITY,          //
	DATACFGERR_VOLWATER_NOTEMPERATURE,      // 212
	DATACFGERR_KINVISC_NODYNVISC,           //
	DATACFGERR_KINVISC_NODENSITY,           // 214
