...
enum rTritonn_Error
{
	...
	DATACFGERR_NOTSYSTEXTFILE,              // 198
	DATACFGERR_INTERFACES_BADNAME,          //
	DATACFGERR_DI,                          // 200
	DATACFGERR_DO,                          //
	DATACFGERR_SAMPLER_TOTALS,              // 202
	DATACFGERR_SAMPLER_CAN,                 //
	DATACFGERR_SAMPLER_METHOD,              // 204
	DATACFGERR_SAMPLER_SETUP,               //
	DATACFGERR_SAMPLER_RESERVE,             // 206
	DATACFGERR_SAMPLER_RESERVE_NF,          //
	DATACFGERR_OBJECT_UNITS,                // 208
	DATACFGERR_PORVE_MISSINGMODULE,         //
	DATACFGERR_AVERAGE_NOINPUT,             // 210
	DATACFGERR_AVERAGE_TOOMANYINPUT,        //
	DATACFGERR_AVERAGE_TOOFEWINPUT,         // 212
	DATACFGERR_AVERAGE_DIFFUNITS,           //
	DATACFGERR_AVERAGE_DIFFFAULTS,          // 214
	DATACFGERR_AVERAGE_TOOMANYFAULTS,       //
	DATACFGERR_AVERAGE_SETUP,               // 216
	DATACFGERR_MASSWATER_SETUP,             //
	DATACFGERR_MASSWATER_NOVOLWATER,        // 218
	DATACFGERR_MASSWATER_NODENSITY,         //
	DATACFGERR_MASSWATER_NOTEMPERATURE,     // 220
	DATACFGERR_VOLWATER_SETUP,              //
	DATACFGERR_VOLWATER_NOMASSWATER,        // 222
	DATACFGERR_VOLWATER_NODENSITY,          //
	DATACFGERR_VOLWATER_NOTEMPERATURE,      // 224
	DATACFGERR_KINVISC_NODYNVISC,           //
	DATACFGERR_KINVISC_NODENSITY,           // 226
	DATACFGERR_DYNVISC_NOKINVISC,           //
	DATACFGERR_DYNVISC_NODENSITY,           // 228
	DATACFGERR_EHTERNET_LOAD_FAULT,         //
	DATACFGERR_EHTERNET_APPLY_FAULT,        // 230
