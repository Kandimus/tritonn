...
enum rTritonn_Error
{
	...
	DATACFGERR_IO_CHANNEL,                  // 190
	DATACFGERR_INVALID_NAME,                //
	DATACFGERR_INVALID_MODULELINK,          // 192
	DATACFGERR_REALTIME_MODULELINK,         //
	DATACFGERR_NOTSYSTEXTFILE,              // 194
	DATACFGERR_INTERFACES_BADNAME,          //
	DATACFGERR_DI,                          // 196
	DATACFGERR_DO,                          //
	DATACFGERR_SAMPLER_TOTALS,              // 198
	DATACFGERR_SAMPLER_CAN,                 //
	DATACFGERR_SAMPLER_METHOD,              // 200
	DATACFGERR_SAMPLER_SETUP,               //
	DATACFGERR_SAMPLER_RESERVE,             // 202
	DATACFGERR_SAMPLER_RESERVE_NF,          //
	DATACFGERR_OBJECT_UNITS,                // 204
	DATACFGERR_PORVE_MISSINGMODULE,         //
	DATACFGERR_AVERAGE_NOINPUT,             // 206
	DATACFGERR_AVERAGE_TOOMANYINPUT,        //
	DATACFGERR_AVERAGE_TOOFEWINPUT,         // 208
	DATACFGERR_AVERAGE_DIFFUNITS,           //
	DATACFGERR_AVERAGE_DIFFFAULTS,          // 210
	DATACFGERR_AVERAGE_TOOMANYFAULTS,       //
	DATACFGERR_AVERAGE_SETUP,               // 212
	DATACFGERR_MASSWATER_SETUP,             //
	DATACFGERR_MASSWATER_NOVOLWATER,        // 214
	DATACFGERR_MASSWATER_NODENSITY,         //
	DATACFGERR_MASSWATER_NOTEMPERATURE,     // 216
	DATACFGERR_VOLWATER_SETUP,              //
	DATACFGERR_VOLWATER_NOMASSWATER,        // 218
	DATACFGERR_VOLWATER_NODENSITY,          //
	DATACFGERR_VOLWATER_NOTEMPERATURE,      // 220
	DATACFGERR_KINVISC_NODYNVISC,           //
	DATACFGERR_KINVISC_NODENSITY,           // 222
	DATACFGERR_DYNVISC_NOKINVISC,           //
	DATACFGERR_DYNVISC_NODENSITY,           // 224
	DATACFGERR_EHTERNET_LOAD_FAULT,         //
	DATACFGERR_EHTERNET_APPLY_FAULT,        // 226
