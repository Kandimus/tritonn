...
CREATE_EID(EID_SYSTEM_DUMPERROR       , EMT_ERROR  , EVENT_OBJ_SYSTEM  , 22)
...
CREATE_EID(EID_STREAM_RESET_TOTALS    , EMT_WARNING, EVENT_OBJ_STREAM  ,  16)
// Stream.Limits
...
CREATE_EID(EID_STATION_RESET_TOTALS   , EMT_WARNING, EVENT_OBJ_STATION ,   5)
// Station.Limits
...
// CINVISC
// Limits
CREATE_EID(EID_KINVISC_NEW_AMIN        , EMT_SUCCESS, EVENT_OBJ_CINVISC, 100)
CREATE_EID(EID_KINVISC_NEW_WMIN        , EMT_SUCCESS, EVENT_OBJ_CINVISC, 101)
CREATE_EID(EID_KINVISC_NEW_WMAX        , EMT_SUCCESS, EVENT_OBJ_CINVISC, 102)
CREATE_EID(EID_KINVISC_NEW_AMAX        , EMT_SUCCESS, EVENT_OBJ_CINVISC, 103)
CREATE_EID(EID_KINVISC_NEW_HYST        , EMT_SUCCESS, EVENT_OBJ_CINVISC, 104)
CREATE_EID(EID_KINVISC_NEW_SETUP       , EMT_SUCCESS, EVENT_OBJ_CINVISC, 105)
CREATE_EID(EID_KINVISC_AMIN            , EMT_ERROR  , EVENT_OBJ_CINVISC, 110)
CREATE_EID(EID_KINVISC_WMIN            , EMT_WARNING, EVENT_OBJ_CINVISC, 111)
CREATE_EID(EID_KINVISC_AMAX            , EMT_ERROR  , EVENT_OBJ_CINVISC, 112)
CREATE_EID(EID_KINVISC_WMAX            , EMT_WARNING, EVENT_OBJ_CINVISC, 113)
CREATE_EID(EID_KINVISC_NORMAL          , EMT_SUCCESS, EVENT_OBJ_CINVISC, 114)
CREATE_EID(EID_KINVISC_NAN             , EMT_ERROR  , EVENT_OBJ_CINVISC, 115)
