...
rSampler::rSampler()
{
	...
	InitLink(rLink::Setup::OUTPUT, m_grab    , U_any, SID::GRAB     , XmlName::GRAB     , rLink::SHADOW_NONE);
	InitLink(rLink::Setup::OUTPUT, m_selected, U_any, SID::CANSELECT, XmlName::SELECTED , rLink::SHADOW_NONE);
}
