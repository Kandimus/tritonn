...
//const rVarFlag VARF______ = rVarFlag::NONE;
...
private:
	void* m_pointer; // Прямой указатель на данные. Использовать вне функций rDataManager::Get и rDataManager::Set запрещено!
};
...
public:
	...
	void  addExternal(const rVariableList& varlist);
	void  sort();
	void  deleteAll(void);
