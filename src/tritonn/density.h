...
const double Dens_K0[6] = {613.9723, 346.42280,  2690.7440, 594.5418, 186.9696, 0.0000};
const double Dens_K1[6] = {  0.0000,   0.43884,     0.0000,   0.0000,   0.4862, 0.6278};
const double Dens_K2[6] = {  0.0000,   0.00000, -0.0033762,   0.0000,   0.0000, 0.0000};


const LREAL Dens_Limit[7][2] = {{611.2, 1163.8},  // PRODUCT_PETROLEUM
