...
const double K0[6] = {613.9723, 346.42280,  2690.7440, 594.5418, 186.9696, 0.0000};
const double K1[6] = {  0.0000,   0.43884,     0.0000,   0.0000,   0.4862, 0.6278};
const double K2[6] = {  0.0000,   0.00000, -0.0033762,   0.0000,   0.0000, 0.0000};
