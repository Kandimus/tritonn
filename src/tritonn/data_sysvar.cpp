...
UDINT rSystemVariable::initVariables(rVariableList& list)
{
	...
	list.add("system.version.hash"       , TYPE_UDINT, rVariable::Flags::RS__, &m_version.m_hash      , U_DIMLESS, ACCESS_SA, "Контрольная сумма сборки");

	list.add("system.metrology.major"    , TYPE_USINT, rVariable::Flags::RS__, &m_metrologyVer.m_major, U_DIMLESS, ACCESS_SA, "Версия метрологически значимой части ПО");
	list.add("system.metrology.minor"    , TYPE_USINT, rVariable::Flags::RS__, &m_metrologyVer.m_minor, U_DIMLESS, ACCESS_SA, "Подверсия метрологически значимой части ПО");
	...
	list.add("system.datetime.sec"       , TYPE_INT  , rVariable::Flags::R___, &DateTime.tm_sec       , U_DIMLESS, 0        , COMMENT::TIME_CURRENT + COMMENT::SECONDS);
	list.add("system.datetime.min"       , TYPE_INT  , rVariable::Flags::R___, &DateTime.tm_min       , U_DIMLESS, 0        , COMMENT::TIME_CURRENT + COMMENT::MINUTES);
	list.add("system.datetime.hour"      , TYPE_INT  , rVariable::Flags::R___, &DateTime.tm_hour      , U_DIMLESS, 0        , COMMENT::TIME_CURRENT + COMMENT::HOURS);
	list.add("system.datetime.day"       , TYPE_INT  , rVariable::Flags::R___, &DateTime.tm_mday      , U_DIMLESS, 0        , COMMENT::TIME_CURRENT + COMMENT::DAY);
	list.add("system.datetime.month"     , TYPE_INT  , rVariable::Flags::R___, &DateTime.tm_mon       , U_DIMLESS, 0        , COMMENT::TIME_CURRENT + COMMENT::MONTH);
	list.add("system.datetime.year"      , TYPE_INT  , rVariable::Flags::R___, &DateTime.tm_year      , U_DIMLESS, 0        , COMMENT::TIME_CURRENT + COMMENT::YEAR);

	list.add("system.datetime.set.sec"   , TYPE_INT  , rVariable::Flags::____, &SetDateTime.tm_sec    , U_DIMLESS, ACCESS_SYSTEM, COMMENT::TIME_SET + COMMENT::SECONDS);
	list.add("system.datetime.set.min"   , TYPE_INT  , rVariable::Flags::____, &SetDateTime.tm_min    , U_DIMLESS, ACCESS_SYSTEM, COMMENT::TIME_SET + COMMENT::MINUTES);
	list.add("system.datetime.set.hour"  , TYPE_INT  , rVariable::Flags::____, &SetDateTime.tm_hour   , U_DIMLESS, ACCESS_SYSTEM, COMMENT::TIME_SET + COMMENT::HOURS);
