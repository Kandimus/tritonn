...
di16.node | uint |  | 512 | Yes |   | Уникальный номер
di16.vendor | udint |  | 512 | Yes |   | Код производителя
di16.productcode | udint |  | 512 | Yes |   | Код устройства
di16.revision | udint |  | 512 | Yes |   | Версия сетевого драйвера
di16.serialnumber | udint |  | 512 | Yes |   | Серийный номер нижнего уровня
di16.can | uint |  | 512 | Yes |   | Состояние обмена данными
di16.firmware | uint |  | 512 | Yes |   | Версия ПО модуля
di16.hardware | uint |  | 512 | Yes |   | Версия модуля
