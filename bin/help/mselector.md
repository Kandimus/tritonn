...
#output_4_name.input_3.fault |  | 522 | OFF | #output_4_name.input_3 | группа 2, флаг ошибки входа 2
...
:-- |:--:|:--:|:--:|:--
#output_1_name |  | 0 | OFF | группа 6, флаг ошибки входа 4
#output_2_name |  | 0 | OFF | группа 7, флаг ошибки входа 1
#output_3_name |  | 0 | OFF | группа 7, флаг ошибки входа 2
#output_4_name |  | 0 | OFF | группа 7, флаг ошибки входа 3
#output_5_name |  | 0 | OFF | группа 7, флаг ошибки входа 4
#output_6_name |  | 0 | OFF | группа 8, флаг ошибки входа 1
#output_7_name |  | 0 | OFF | группа 8, флаг ошибки входа 2
#output_8_name |  | 0 | OFF | группа 8, флаг ошибки входа 3
...
#output_1_name.input_1.fault | LREAL |  | 522 | Yes |   | группа 6, входное значение 4
#output_1_name.input_2.value | LREAL |  | 0 | Yes |   | > НЕТ ОПИСАНИЯ! <. Текущее значение
#output_1_name.input_2.unit | STRID |  | 512 | Yes |   | > НЕТ ОПИСАНИЯ! <. Единицы измерения
#output_1_name.input_2.fault | LREAL |  | 522 | Yes |   | группа 7, входное значение 1
#output_1_name.input_3.value | LREAL |  | 0 | Yes |   | > НЕТ ОПИСАНИЯ! <. Текущее значение
#output_1_name.input_3.unit | STRID |  | 512 | Yes |   | > НЕТ ОПИСАНИЯ! <. Единицы измерения
#output_1_name.input_3.fault | LREAL |  | 522 | Yes |   | группа 7, входное значение 2
#output_1_name.input_4.value | LREAL |  | 0 | Yes |   | > НЕТ ОПИСАНИЯ! <. Текущее значение
#output_1_name.input_4.unit | STRID |  | 512 | Yes |   | > НЕТ ОПИСАНИЯ! <. Единицы измерения
#output_1_name.input_4.fault | LREAL |  | 522 | Yes |   | группа 7, входное значение 3
#output_2_name.input_1.value | LREAL |  | 0 | Yes |   | > НЕТ ОПИСАНИЯ! <. Текущее значение
#output_2_name.input_1.unit | STRID |  | 512 | Yes |   | > НЕТ ОПИСАНИЯ! <. Единицы измерения
#output_2_name.input_1.fault | LREAL |  | 522 | Yes |   | группа 7, входное значение 4
#output_2_name.input_2.value | LREAL |  | 0 | Yes |   | > НЕТ ОПИСАНИЯ! <. Текущее значение
#output_2_name.input_2.unit | STRID |  | 512 | Yes |   | > НЕТ ОПИСАНИЯ! <. Единицы измерения
#output_2_name.input_2.fault | LREAL |  | 522 | Yes |   | группа 8, входное значение 1
#output_2_name.input_3.value | LREAL |  | 0 | Yes |   | > НЕТ ОПИСАНИЯ! <. Текущее значение
#output_2_name.input_3.unit | STRID |  | 512 | Yes |   | > НЕТ ОПИСАНИЯ! <. Единицы измерения
#output_2_name.input_3.fault | LREAL |  | 522 | Yes |   | группа 8, входное значение 2
#output_2_name.input_4.value | LREAL |  | 0 | Yes |   | > НЕТ ОПИСАНИЯ! <. Текущее значение
#output_2_name.input_4.unit | STRID |  | 512 | Yes |   | > НЕТ ОПИСАНИЯ! <. Единицы измерения
#output_2_name.input_4.fault | LREAL |  | 522 | Yes |   | группа 8, входное значение 3
#output_3_name.input_1.value | LREAL |  | 0 | Yes |   | > НЕТ ОПИСАНИЯ! <. Текущее значение
#output_3_name.input_1.unit | STRID |  | 512 | Yes |   | > НЕТ ОПИСАНИЯ! <. Единицы измерения
#output_3_name.input_1.fault | LREAL |  | 522 | Yes |   | группа 8, входное значение 4
#output_3_name.input_2.value | LREAL |  | 0 | Yes |   | > НЕТ ОПИСАНИЯ! <. Текущее значение
#output_3_name.input_2.unit | STRID |  | 512 | Yes |   | > НЕТ ОПИСАНИЯ! <. Единицы измерения
#output_3_name.input_2.fault | LREAL |  | 522 | Yes |   | группа 1, флаг ошибки входа 1
#output_3_name.input_3.value | LREAL |  | 0 | Yes |   | группа 1, входное значение 2. Текущее значение
#output_3_name.input_3.unit | STRID |  | 512 | Yes |   | группа 1, входное значение 2. Единицы измерения
#output_3_name.input_3.fault | LREAL |  | 522 | Yes |   | группа 1, флаг ошибки входа 2
#output_3_name.input_4.value | LREAL |  | 0 | Yes |   | группа 1, входное значение 3. Текущее значение
#output_3_name.input_4.unit | STRID |  | 512 | Yes |   | группа 1, входное значение 3. Единицы измерения
#output_3_name.input_4.fault | LREAL |  | 522 | Yes |   | группа 1, флаг ошибки входа 3
#output_4_name.input_1.value | LREAL |  | 0 | Yes |   | группа 1, входное значение 4. Текущее значение
#output_4_name.input_1.unit | STRID |  | 512 | Yes |   | группа 1, входное значение 4. Единицы измерения
#output_4_name.input_1.fault | LREAL |  | 522 | Yes |   | группа 1, флаг ошибки входа 4
#output_4_name.input_2.value | LREAL |  | 0 | Yes |   | группа 2, входное значение 1. Текущее значение
...
#output_7_name.input_2.fault | LREAL |  | 522 | Yes |   | группа 5, флаг ошибки входа 1
