...
:-- |:--:|:--:|:--:|:--:|:-- |:--
do16.type | uint |  | 512 | Yes |   | Тип модуля:<br>0: Модуль не определен<br/>1: Базовый модуль ЦПУ<br/>2: Модуль AI6a<br/>3: Модуль AI6p<br/>4: Модуль FI4<br/>5: Модуль DI8DO8<br/>6: Модуль DI16<br/>7: Модуль DO16<br/>8: Модуль CRM<br/>
...
do16.ch_00.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_01.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_02.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_03.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_04.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_05.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_06.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_07.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_08.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_09.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_10.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_11.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_12.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_13.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_14.value | uint |  | 512 | Yes |   | Текущее значение
...
do16.ch_15.value | uint |  | 512 | Yes |   | Текущее значение
