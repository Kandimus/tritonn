...
fi4.ch_00.frequecy | UDINT | Гц | 192 | Yes |   | Частота
fi4.ch_00.state | USINT |  | 512 | Yes |   | Статус:<br/>Нет данных
fi4.ch_00.simulate.max | UINT |  | 512 |  |   | Максимум симулированного значения
fi4.ch_00.simulate.min | UINT |  | 512 |  |   | Минимум симулированного значения
fi4.ch_00.simulate.value | UINT |  | 512 |  |   | Симулированное значение
fi4.ch_00.simulate.speed | INT |  | 512 |  |   | Скорость изменения симулированного значения
