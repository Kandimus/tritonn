...
di8do8.ch_01.simulate.value | USINT |  | 512 |  |   | Значение симулированного значения
...
di8do8.ch_02.simulate.value | USINT |  | 512 |  |   | Значение симулированного значения
...
di8do8.ch_03.simulate.value | USINT |  | 512 |  |   | Значение симулированного значения
...
di8do8.ch_04.simulate.value | USINT |  | 512 |  |   | Значение симулированного значения
...
di8do8.ch_05.simulate.value | USINT |  | 512 |  |   | Значение симулированного значения
...
di8do8.ch_06.simulate.value | USINT |  | 512 |  |   | Значение симулированного значения
...
di8do8.ch_07.simulate.value | USINT |  | 512 |  |   | Значение симулированного значения
di8do8.ch_07.simulate.blink | UDINT | мс | 210 |  |   | Период мигания
di8do8.ch_08.simulate.type | USINT |  | 512 |  |   | Тип симуляции (зависит от типа канала) [^simtype]
di8do8.ch_08.setup | UINT |  | 512 | Yes |   | Настройка:<br/>0x0001: Выключен и не обрабатывается<br/>0x0002: Устранение дребезга<br/>0x0004: Инверсия значения<br/>
di8do8.ch_08.value | USINT |  | 512 | Yes |   | Текущее значение
di8do8.ch_08.state | USINT |  | 512 | Yes |   | Статус:<br/>Нет данных
di8do8.ch_08.bounce | UDINT | мс | 210 |  |   | Значение таймера антидребезга
di8do8.ch_08.simulate.value | USINT |  | 512 |  |   | Значение симулированного значения
di8do8.ch_08.simulate.blink | UDINT | мс | 210 |  |   | Период мигания
di8do8.ch_09.simulate.type | USINT |  | 512 |  |   | Тип симуляции (зависит от типа канала) [^simtype]
di8do8.ch_09.setup | UINT |  | 512 | Yes |   | Настройка:<br/>0x0001: Выключен и не обрабатывается<br/>0x0004: Инверсия значения<br/>
di8do8.ch_09.value | USINT |  | 512 | Yes |   | Текущее значение
di8do8.ch_09.state | USINT |  | 512 | Yes |   | Статус:<br/>Нет данных
di8do8.ch_10.simulate.type | USINT |  | 512 |  |   | Тип симуляции (зависит от типа канала) [^simtype]
di8do8.ch_10.setup | UINT |  | 512 | Yes |   | Настройка:<br/>0x0001: Выключен и не обрабатывается<br/>0x0004: Инверсия значения<br/>
di8do8.ch_10.value | USINT |  | 512 | Yes |   | Текущее значение
di8do8.ch_10.state | USINT |  | 512 | Yes |   | Статус:<br/>Нет данных
di8do8.ch_11.simulate.type | USINT |  | 512 |  |   | Тип симуляции (зависит от типа канала) [^simtype]
di8do8.ch_11.setup | UINT |  | 512 | Yes |   | Настройка:<br/>0x0001: Выключен и не обрабатывается<br/>0x0004: Инверсия значения<br/>
di8do8.ch_11.value | USINT |  | 512 | Yes |   | Текущее значение
di8do8.ch_11.state | USINT |  | 512 | Yes |   | Статус:<br/>Нет данных
di8do8.ch_12.simulate.type | USINT |  | 512 |  |   | Тип симуляции (зависит от типа канала) [^simtype]
di8do8.ch_12.setup | UINT |  | 512 | Yes |   | Настройка:<br/>0x0001: Выключен и не обрабатывается<br/>0x0004: Инверсия значения<br/>
di8do8.ch_12.value | USINT |  | 512 | Yes |   | Текущее значение
di8do8.ch_12.state | USINT |  | 512 | Yes |   | Статус:<br/>Нет данных
di8do8.ch_13.simulate.type | USINT |  | 512 |  |   | Тип симуляции (зависит от типа канала) [^simtype]
di8do8.ch_13.setup | UINT |  | 512 | Yes |   | Настройка:<br/>0x0001: Выключен и не обрабатывается<br/>0x0004: Инверсия значения<br/>
di8do8.ch_13.value | USINT |  | 512 | Yes |   | Текущее значение
di8do8.ch_13.state | USINT |  | 512 | Yes |   | Статус:<br/>Нет данных
di8do8.ch_14.simulate.type | USINT |  | 512 |  |   | Тип симуляции (зависит от типа канала) [^simtype]
di8do8.ch_14.setup | UINT |  | 512 | Yes |   | Настройка:<br/>0x0001: Выключен и не обрабатывается<br/>0x0004: Инверсия значения<br/>
di8do8.ch_14.value | USINT |  | 512 | Yes |   | Текущее значение
di8do8.ch_14.state | USINT |  | 512 | Yes |   | Статус:<br/>Нет данных
di8do8.ch_15.simulate.type | USINT |  | 512 |  |   | Тип симуляции (зависит от типа канала) [^simtype]
di8do8.ch_15.setup | UINT |  | 512 | Yes |   | Настройка:<br/>0x0001: Выключен и не обрабатывается<br/>0x0004: Инверсия значения<br/>
di8do8.ch_15.value | USINT |  | 512 | Yes |   | Текущее значение
di8do8.ch_15.state | USINT |  | 512 | Yes |   | Статус:<br/>Нет данных
di8do8.ch_16.simulate.type | USINT |  | 512 |  |   | Тип симуляции (зависит от типа канала) [^simtype]
di8do8.ch_16.setup | UINT |  | 512 | Yes |   | Настройка:<br/>0x0001: Выключен и не обрабатывается<br/>0x0004: Инверсия значения<br/>
di8do8.ch_16.value | USINT |  | 512 | Yes |   | Текущее значение
di8do8.ch_16.state | USINT |  | 512 | Yes |   | Статус:<br/>Нет данных
